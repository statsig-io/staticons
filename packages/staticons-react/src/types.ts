...
export interface StaticonProps extends ElementAttributes {
  size?: string | number;
  absoluteStrokeWidth?: boolean;
}

export type StaticonIcon = ForwardRefExoticComponent<
  Omit<StaticonProps, "ref"> & RefAttributes<SVGSVGElement>
>;
